...
\usepackage{graphicx}
\usepackage{multicol} % for optional cols (if 2col need to make text-width bigger to compensate)
\setlength\columnsep{17pt}
\usepackage{listings} % for code in appendices (link main stuff to github)

\usepackage[a4paper, total={7in, 9.7in}]{geometry} % set the paper/text sizes 7,9.5 in seems nice
\geometry{footskip=1.6cm}
...
% \ead{2259886d@student.gla.ac.uk}
