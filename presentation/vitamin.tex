...
\titlegraphic{\includegraphics[width=0.3\linewidth]{img/UofG} 
              \includegraphics[width=0.37\linewidth]{img/ligo2.png}}
            %   \includegraphics[width=0.15\linewidth]{img/Cambridge}}
% \titlegraphic{\includegraphics[width=0.1\linewidth]{img/ORCIDiD_icon}}
...
{
%   \usebackgroundtemplate{\includegraphics[width=\paperwidth]{figures/sigmoid_back.jpg}}
  \begin{frame}
    \titlepage
    \date{}
  \end{frame}
...
\includegraphics[height = 35mm, width=40mm]{img/sigmoid_img}
\end{textblock*}
\begin{textblock*}{30mm}(83mm,50mm)
\includegraphics[height = 35mm, width=37mm]{img/aia1600}
\end{textblock*}
...
% \includegraphics[trim = 1 10 10 1, clip, width=1.2\linewidth]{img/aia_context2}
% \end{textblock*}
% \begin{textblock*}{30mm}(83mm,50mm)
% \includegraphics[height = 35mm, width=37mm]{img/aia_context2}
% \end{textblock*}
% 
...
\includegraphics[height = 20mm, width = 40mm]{img/sig1}
\end{textblock*}
\begin{textblock*}{70mm}(70mm,10mm)
\includegraphics[height = 20mm, width = 40mm]{img/sig2}
\end{textblock*}

% Adding two sigmoid images
\begin{textblock*}{200mm}(3mm,42mm)
\includegraphics[height = 17mm, width = 120mm]{img/sig3}
\end{textblock*}
\begin{textblock*}{200mm}(3mm,59mm)
\includegraphics[height = 5mm, width = 120mm]{img/sig4}
\end{textblock*} 

% Adding two sigmoid images
\begin{textblock*}{205mm}(4mm,65mm)
\includegraphics[height = 16mm, width = 120mm]{img/sig5}
\end{textblock*}
\begin{textblock*}{210mm}(4mm,81.5mm)
\includegraphics[height = 4mm, width = 121mm]{img/sig6}
\end{textblock*} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Adjust 2x2 or 3x3 figures in a frame
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Adjust 1x2 or 1x3 figures in a frame}
\begin{figure}
  \centering
  \subfloat[First subfigure\label{fig:a}]{\includegraphics[height=2cm,width=3cm]{figures/ORCIDiD_icon.png}}\qquad
  \subfloat[Second subfigure\label{fig:b}]{\includegraphics[height=2cm,width=3cm]{figures/ORCIDiD_icon.png}}
\caption{A figure}
\label{fig:1}
\end{figure}
...
\begin{figure}
  \centering
  \subfloat[Third subfigure\label{fig:c}]{\includegraphics[height=2cm,width=3cm]{figures/ORCIDiD_icon.png}}\qquad    
  \subfloat[Fourth subfigure\label{fig:d}]{\includegraphics[height=2cm,width=3cm]{figures/ORCIDiD_icon.png}}%\qquad
  \subfloat[Fifth subfigure\label{fig:e}]{\includegraphics[height=2cm,width=3cm]{figures/ORCIDiD_icon.png}}
...
\begin{frame}{2X2 figures}
    \begin{columns}[t]
        \column{.5\textwidth}
        \includegraphics[width=\columnwidth,height=3cm]{figures/ORCIDiD_icon.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Text in a Column + figures in a column
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Two columns - Text + figures}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{figure}
                ...
                \begin{subfigure}%[t]{0.3 cm}
                    \left
                    \includegraphics[height=1cm,width=2cm]{figures/ORCIDiD_icon.png}
...
\begin{figure}[!htpb]
\label{fig:leslie}
\includegraphics[width=2.5cm]{figures/ORCIDiD_icon.png}
\includegraphics[width=2.5cm]{figures/ORCIDiD_icon.png}
\includegraphics[width=2.5cm]{figures/ORCIDiD_icon.png}
\includegraphics[width=2.5cm]{figures/ORCIDiD_icon.png}
\includegraphics[width=2.5cm]{figures/ORCIDiD_icon.png}
...
{\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight]{figures/ORCIDiD_icon.png}} 
...
{\usebackgroundtemplate{%
  \includegraphics[width=5 cm,height=5 cm]{figures/ORCIDiD_icon.png}} 
\begin{frame}
 \begin{textblock}{10.0}(1,2)
...
\begin{frame}{Positioning a single image}
 \includegraphics[width=3cm, heigth=3cm]{figures/cube}
...
\begin{center}
% 	\movie[externalviewer]{\includegraphics[width=3cm]{figures/arrow}}{videos/aia_xrt_simul_spire.mp4}
	\qquad
...
% 
%   
%   \vspace*{-3.5cm} \hspace*{8.9cm}\includegraphics[width=0.25\linewidth]{img/sigmoid_img}
% %  \vspace*{-10pt} \hspace*{250pt}\includegraphics[width=0.25\linewidth]{img/sigmoid_img}
%  \setlength{\TPHorizModule}{\textwidth}
%  \setlength{\TPVertModule}{\textwidth}
%  
% %  \begin{textblock*}{20}(200,50)
% %   includegraphics[width=0.5\linewidth]{img/sigmoid_img}
% %  \end{textblock*}
%  
% %  \begin{textblock*}{200}(50,200)
% %   || Shree Swami Samartha||
...
%       \only<1>
%         {%
%           \includegraphics[width=.4\textwidth]{figures/cube.PNG}%
%         }%
%       \only<2>
%         {%
%           \includegraphics[width=.4\textwidth]{figures/ORCIDiD_icon.png}%
%         }%
%       \only<3>
%         {%
%           \includegraphics[width=.4\textwidth]{figures/arrow.PNG}%
%         }%
%     \end{figure}
%   \end{overlayarea}      
% \end{frame}
